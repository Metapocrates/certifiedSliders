...
interface ServerActionImageUploaderProps {
  ...
  uploadAction: (formData: FormData) => Promise<{ ok: boolean; message: string; url?: string }>;
  currentImageUrl?: string;
  label?: string;
  helperText?: string;
}

export default function ServerActionImageUploader({
  onImageUploaded,
  uploadAction,
  currentImageUrl,
  label = 'Upload Image',
  helperText,
}: ServerActionImageUploaderProps) {
