...
export default async function HSCoachComingSoonPage() {
  ...
  return (
    <div className="container max-w-3xl mx-auto px-4 py-16 space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-app">High School Coach Portal</h1>
      ...
      <div className="rounded-xl border border-app bg-card p-8 space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          The High School Coach Portal will streamline team management and help showcase your athletes to college recruiters.
        </p>
        <ul className="space-y-2 text-muted-foreground">
          <li className="flex items-start gap-2">
            <span className="text-scarlet">✓</span>
            <span>Manage your team roster and athlete profiles</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-scarlet">✓</span>
            <span>Submit and track meet results for your athletes</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-scarlet">✓</span>
            <span>Verify and attest to athlete performances</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-scarlet">✓</span>
            <span>Showcase your program to college coaches</span>
          </li>
        </ul>
      </div>
